...
//	bool RegisterWindow( HINSTANCE instance, int _width = 800, int _height = 600, char* _class_name = "Win32Class");
	...
	bool DisplayWindow()	{ if(ShowWindow(GetHandle(), 1))	return true; else return false;   }
	win32(char *title_ );
	~win32(void);
...
private:
	WNDCLASSEX m_window;		//Structure to hold m_windows properties
	...
	//Called through CreateWin32Window
